...
## Coding explanation
Nelson-Aalen plot is the plot in the cumulative hazard. The `ggsurvfit` function accept multiple statistics: "survival" (KM plot), "risk" (Cumulative incidence), "cumhaz" (NA plot), "cloglog" (complimentary log-log survival).
It is necessary to transform the Y axis to the log scale. (The PH assumption is in log)
:::
