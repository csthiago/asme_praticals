...
Some notes:
Additive scale in this practical can be seem as  "risk difference", while multiplicative as "risk ratio". Don't get confused with additive from "generalized additive models"
